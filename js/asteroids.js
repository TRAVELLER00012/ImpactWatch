...
export class Asteroids{
    constructor(start_date = new Date(),end_date = new Date(), scale_size = 0.225, distance_scale = 1.2e6, velocity_scale = 1e6){
        ...
        for (let key of keys){
            ...
            for (let o of obj ){
                ...
                converted_result.push({
                    "id":o.id,
                    "scaled_value":(o.estimated_diameter.kilometers.estimated_diameter_max + o.estimated_diameter.kilometers.estimated_diameter_min) / (2*this.scale_size),
